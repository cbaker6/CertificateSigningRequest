...
This is a port of ios-csr by Ales Teska (https://github.com/ateska/ios-csr) from Objective-C to Swift 2.3 (a Swift 3.0 version is available on the "main" branch). 
Additions have been made to allow SHA256 and SHA512. Also, this is setup to be added as a framework to your project.

To use, initiatlize the class using one of the following (an example of how to do can be found at https://github.com/cbaker6/iOSCSRSwift/blob/2.3/iOSCSRSwiftTests/iOSCSRSwiftTests.swift): 
